...
<div id="container">
    <div class="container">
        ...
        <ul class="breadcrumb">
            ...
            <li><a href="<?=http().'basket'?>">سبد خرید</a></li>
        </ul>
        <!-- Breadcrumb End-->
        <div class="row">
            <!--Middle Part Start-->
...
//                        unset($_SESSION['cart']);
                                ...
                                <tr>
                                    ...
                                    <td class="text-left " style="width: 94px">
                                        ...
                                        <div class="qty" style="width: 64px">
                                            <input type="text" name="quantity" value="<?=$row['qty']?>" size="2" id="input-quantity-<?=$row['proID']?>" class="form-control" />
                ...
                <h2 style="display: none" class="subtitle">حالا مایلید چه کاری انجام دهید؟</h2>
                <p style="display: none">در صورتی که کد تخفیف در اختیار دارید میتوانید از آن در اینجا استفاده کنید.</p>
                    ...
                    <div class="col-sm-4 col-sm-offset-8">
                        <table class="table table-bordered">
                            <tr>
                                ...
                                <td class="text-right"><?=$totalFactor.' '.$currentSetting->currency?></td>
                            </tr>
...
<!--                            </tr>-->
                ...
                <div class="buttons">
                    <div class="pull-left"><a href="<?=http().'categories'?>" class="btn btn-default">ادامه خرید</a></div>
                    <div class="pull-right"><a href="<?=http().'invoce'?>" class="btn btn-primary">تسویه حساب</a></div>
                </div>
            </div>
            <!--Middle Part End -->
        </div>
