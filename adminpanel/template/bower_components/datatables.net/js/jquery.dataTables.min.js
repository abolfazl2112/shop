...
"_"+location.pathname,JSON.stringify(b))}catch(c){}},fnStateSaveParams:null,iStateDuration:7200,iDeferLoading:null,iDisplayLength:10,iDisplayStart:0,iTabIndex:0,oClasses:{},oLanguage:{oAria:{
    sSortAscending:": مرتب کردن بصورت صعودی",
    sSortDescending:": مرتب کردن بصورت نزولی"},
    oPaginate:{
        sFirst:"اولین",
        sLast:"آخرین",
        sNext:"بعدی",
    ...
    sInfo:"نمایش از _START_ تا _END_ - کل _TOTAL_ مورد",
    sInfoEmpty:"از 0 تا 0  - از کل 0 مورد",
    sInfoFiltered:"(فیلتر شده از _MAX_  مورد)",
    sInfoPostFix:"",sDecimal:"",sThousands:",",
    sLengthMenu:"تعداد در صفحه _MENU_",
    sLoadingRecords:"در حال بروزرسانی...",
    sProcessing:"در حال پردازش...",
    sSearch:"جستجو:",
    sSearchPlaceholder:"",sUrl:"",
    sZeroRecords:"مورد مشابهی یافت نشد"
