            ...
            <div class="col-md-3">
                ...
                <div class="box box-primary">
                    <div class="box-body box-profile">
                        <img class="profile-user-img img-responsive img-circle" src="template/dist/img/user4-128x128.jpg" alt="User profile picture">
                        ...
                        <div class="active tab-pane" id="activity">
                          ...
                          <a href="#" class="pull-left btn-box-tool"><i class="fa fa-times"></i></a>
                                ...
                                <div class="row margin-bottom">
                                    <div class="col-sm-6">
                                        <img class="img-responsive" src="template/dist/img/photo1.png" alt="Photo">
                                    </div>
                                    <!-- /.col -->
                                    <div class="col-sm-6">
                                        <div class="row">
                                            <div class="col-sm-6">
                                                <img class="img-responsive" src="template/dist/img/photo2.png" alt="Photo">
                                                <br>
                                                <img class="img-responsive" src="template/dist/img/photo3.jpg" alt="Photo">
                                            </div>
                                            <!-- /.col -->
                                            <div class="col-sm-6">
                                                <img class="img-responsive" src="template/dist/img/photo4.jpg" alt="Photo">
                                                <br>
                                                <img class="img-responsive" src="template/dist/img/photo1.png" alt="Photo">
                                            </div>
                                            <!-- /.col -->
